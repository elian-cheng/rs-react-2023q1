...
describe('Radio', () => {
  ...
  it('should render ther component correctly', () => {
    render(<Radio validationRules={validationRules} register={register} error={error} />);
    expect(screen.getByText('Do you need an order confirmation call?')).toBeInTheDocument();
